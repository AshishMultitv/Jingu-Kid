...
class Constant: NSObject {
    ...
    static let onemonthsubscription = "Jingu30days"
    static let threemonthsubscription = "Jingu90days"
    static let sixmonthsubscription = "Jingu180days"
    static let oneyearsubscription = "Jingu365days"
    static let iapsecreatKey = "efc84e0188194dc6b9a14e24f40b3e41"
 
    
    
    
   static func getsubscriptionid(type:String) -> String
    {
        switch type {
        case "1 Month":
             return Constant.onemonthsubscription
        case "3 Month":
            return Constant.onemonthsubscription
        case "6 Month":
            return Constant.onemonthsubscription
        case "1 Year":
            return Constant.oneyearsubscription
        default:
            return ""
         }
     }
