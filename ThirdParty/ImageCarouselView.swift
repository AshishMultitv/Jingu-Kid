...
class ImageCarouselView: UIView {
    ...
    func addImages() {
        ...
        for i in 0..<imageurlarry.count {
            ...
            let label = UILabel.init(frame: CGRect.init(x: ((bounds.width * CGFloat(i))+10), y: bounds.height-50, width: bounds.width-10, height: 50))
            let label1 = UILabel.init(frame: CGRect.init(x: ((bounds.width * CGFloat(i))+10), y: label.frame.origin.y+15, width: bounds.width-10, height: 50))
            let label2 = UILabel.init(frame: CGRect.init(x: ((bounds.width * CGFloat(i))+10), y: label1.frame.origin.y+15, width: bounds.width-10, height: 50))
            label.text = textarray.object(at: i) as? String
            label.font = UIFont(name: "Baloo", size: CGFloat(20))
            label.textAlignment = .center
            label.textColor = UIColor.white
            label.numberOfLines = 1
            label1.text = textarraydes.object(at: i) as? String
            label1.font = UIFont(name: "Baloo", size: CGFloat(18))
            ...
            label2.font = UIFont(name: "Baloo", size: CGFloat(15))
    ...
    func addPageControl() {
        if imageurlarry.count <= pageControlMaxItems {
            ...
            pageLabel.textColor = UIColor.yellow
