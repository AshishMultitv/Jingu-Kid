...
class FavouriteViewController: UIViewController,UITableViewDataSource,UITableViewDelegate,UICollectionViewDataSource, UICollectionViewDelegate,UICollectionViewDelegateFlowLayout {
   ...
   //  var url = String(format: "%@%@/device/ios/user_id/%@/max_counter/20/type/favorite/current_offset/%@", LoginCredentials.Userrelatedapi,Apptoken,(dict.value(forKey: "id") as! NSNumber).stringValue,display_offset)
   
        
       var url = String(format: "%@%@/device/ios/current_version/0.0/max_counter/100/current_offset/0/user_id/%@/type/favorite", LoginCredentials.Userrelatedapi,Apptoken,(dict.value(forKey: "id") as! NSNumber).stringValue)
        
        
        if(Common.Islogin() && LoginCredentials.Agegroup != "0-0" && Common.isNotNull(object: LoginCredentials.Agegroup as AnyObject))
        {
            url = String(format: "%@%@/device/ios/current_version/0.0/max_counter/100/current_offset/0/user_id/%@/type/favorite/age_group/%@", LoginCredentials.Userrelatedapi,Apptoken,(dict.value(forKey: "id") as! NSNumber).stringValue,LoginCredentials.Agegroup)
        }
        
        
        
   // var url = String(format: "%@%@/device/ios/current_version/0.0/max_counter/100/current_offset/%@/user_id/%@/type/favorite", LoginCredentials.Userrelatedapi,Apptoken,display_offset,(dict.value.value(forKey: "id") as! NSNumber).stringValue)
