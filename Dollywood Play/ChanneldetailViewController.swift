...
class ChanneldetailViewController: UIViewController,MXSegmentedPagerDataSource,MXSegmentedPagerDelegate,UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout{
    ...
    @IBAction func Taptosubcribechnl(_ sender: UIButton) {
        ...
        if(Common.Islogin())
        {
            ...
            if(issubcribe)
            {
                ...
                let alert = UIAlertController(title: "YUV", message: "Unsubscribe from \(chanldict.value(forKey: "first_name") as! String)\(" ")\(chanldict.value(forKey: "last_name") as! String) ?", preferredStyle: UIAlertControllerStyle.alert)
    ...
    func subscribechnl()
    {
        ...
        manager.post(url, parameters: parameters, progress: nil, success: { (task: URLSessionDataTask, responseObject: Any?) in
            if (responseObject as? [String: AnyObject]) != nil {
                ...
                {
                    self.notificatiobbutton.isHidden = false
                    self.ischnlnotificationsubcribed = true
                    self.notificatiobbutton.setImage(UIImage.init(named: "notificationenable"), for: .normal)
        ...
        Common.startloder(view: self.view)
            ...
            if(LoginCredentials.IsencriptUserbehaviorapi)
            {
                parameters = [
                    ...
                    "content_id":"",
                    "ch_id":chanldict.value(forKey: "id") as! String,
                    "favorite":""
                ]
                
                url = String(format: "%@%@/device/ios/user_id/%@/content_id", LoginCredentials.Userbehaviorapi,Apptoken,dict.value(forKey: "id") as! String)
            ...
            else
            {
                ...
                url = String(format: "%@%@/device/ios/user_id/%@/content_id/ch_id/%@/favorite", LoginCredentials.Userbehaviorapi,Apptoken,dict.value(forKey: "id") as! String,chanldict.value(forKey: "id") as! String)
        ...
        manager.get(url, parameters: nil, progress: nil, success: { (task: URLSessionDataTask, responseObject: Any?) in
            if (responseObject as? [String: AnyObject]) != nil {
                ...
                else
                {
                    ...
                    if( (dict.value(forKey: "behaviour") as! NSDictionary).value(forKey: "is_subscriber") as! String == "0")
                    {
    ...
    func Getchannelplaylist()
    {
        ...
        print(parameters)
     var url = String(format: "%@%@/content_partner/%@/device/ios", LoginCredentials.Playlistapi,Apptoken,chanldict.value(forKey: "id") as! String)
        url = url.trimmingCharacters(in: .whitespaces)
    ...
    func Getchannelvideolist()
    {
        ...
        var url = String(format: "%@%@/content_partner_id/%@/device/ios/max_counter/ios", LoginCredentials.Listapi,Apptoken,chanldict.value(forKey: "id") as! String)
        url = url.trimmingCharacters(in: .whitespaces)
...
func setchanneldetail()
{
    ...
    {
       let str  = channeldetaildict.value(forKey: "banner_image") as! String
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        let url = ((((self.videodata.object(at: indexPath.row) as! NSDictionary).value(forKey: "thumbs") as! NSArray).object(at: 0) as! NSDictionary).value(forKey: "thumb") as! NSDictionary).value(forKey: "medium") as! String
        ...
        else
        {
            ...
            let url = (playlistarray.object(at: indexPath.row) as! NSDictionary).value(forKey: "thumb") as! String
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        else
        {
            ...
            if(Common.Isuserissubscribe(Userdetails: ids as AnyObject))
            {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath)
    {
        ...
        else
        {
            ...
            if(Common.Isuserissubscribe(Userdetails: catdataarray as AnyObject))
            {
                self.navigationController?.pushViewController(playerViewController, animated: true)
            }
            else
