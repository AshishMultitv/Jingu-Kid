...
//        
//        parameters = [ "user_id":dict.value(forKey: "id") as! String,
//                       "device":"ios",
//                       "id": userintresetedid
//        ]
//        
//        let url = String(format: "%@/interest/add/token/%@", BaseUrl,Apptoken)
...
//        
//        
//        let url = String(format: "%@/interest/list/token/%@", BaseUrl,Apptoken)
//        let manager = AFHTTPSessionManager()
